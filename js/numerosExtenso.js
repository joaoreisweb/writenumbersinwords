...
// ------- Properties -------
var numUnidadesArrPT = new Array("zero","um","dois","três","quatro","cinco","seis","sete","oito","nove","dez","onze","doze","treze","cartoze","quinze","dezasseis","dezassete","dezoito","dezanove");
var numUnidadesArrBR = new Array("zero","um","dois","três","quatro","cinco","seis","sete","oito","nove","dez","onze","doze","treze","quartoze","quinze","dezesseis","dezessete","dezoito","dezenove");
...
// ------- Methods -------
function numerosPorExtenso(valornumerico, langSigla) {
	lang = langSigla;
	if (valornumerico.search(centavosFindInicial) != -1) {
	...
	e = Number(nS);
		...
		function eurosPorExtenso(valornumerico, langSigla) {
			...
			centavosExtenso = "";
			var textCentimos="";
			numerosPorExtenso(valornumerico, lang);
	...
	//////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////unidades + dezenas
	function dezenasUnidadesValor(uni) {
		//0X
